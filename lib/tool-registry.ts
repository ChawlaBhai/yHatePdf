...
const ready = new Set(["merge", "split", "rotate", "organize", "delete-pages", "extract-pages", "reverse-pages", "duplicate-pages", "odd-pages", "even-pages", "crop", "resize", "compress", "page-numbers", "watermark", "headers-footers", "metadata", "remove-metadata", "images-to-pdf", "scan-to-pdf", "pdf-to-text", "pdf-to-markdown", "pdf-to-html", "pdf-to-jpg", "pdf-to-png", "pdf-to-webp", "pdf-to-zip", "create-pdf", "markdown-to-pdf", "csv-to-pdf", "grayscale", "invert", "flatten", "compare", "remove-blank-pages", "sign", "edit-pdf", "html-to-pdf", "pdf-to-word", "word-to-pdf", "pdf-to-excel", "excel-to-pdf", "pdf-to-powerpoint", "powerpoint-to-pdf", "studio", "annotate", "extract-images", "redact", "repair", "protect", "unlock", "ocr"]);
...
export const tools: Tool[] = [
  ...
  make("powerpoint-to-pdf", "PowerPoint to PDF", "Convert selectable PPTX slide text into a clean widescreen PDF deck; original graphics and positioning are not preserved.", "convert", ["pptx", "slides", "text"], FileText, ".pptx", "PDF"),
  ...
  make("scan-to-pdf", "Scan to PDF", "Capture page by page, retake, clean, crop, rotate, reorder, and save one PDF.", "create", ["camera", "phone", "retake", "scanner"], ScanText, img),
  ...
  make("edit-pdf", "Edit PDF", "Open PDF Studio to place text, images, signatures, highlights, shapes and redactions directly on pages.", "edit", ["change text", "editor", "studio", "objects"], PenLine),
  ...
  make("protect", "Protect PDF", "Apply AES-256 encryption, open and owner passwords, plus print, edit, and copy permissions locally.", "security", ["password", "lock", "encrypt", "aes"], LockKeyhole),
  make("unlock", "Unlock PDF", "Remove encryption and restrictions locally with the correct user or owner password.", "security", ["password", "decrypt", "remove"], LockKeyhole),
  make("redact", "Redact PDF", "Place secure redaction areas and flatten affected pages so covered content is permanently removed.", "security", ["hide text", "blackout", "private", "secure"], ShieldCheck),
  ...
  make("ocr", "Searchable PDF", "Recognize English text in selected scanned pages and embed a local searchable text layer.", "utility", ["ocr", "scan", "recognize", "search"], ScanText),
  ...
  make("repair", "Repair PDF", "Recover readable objects and rewrite them into a clean PDF structure.", "utility", ["fix", "broken", "recover"], Settings2),
