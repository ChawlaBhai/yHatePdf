...
export const tools: Tool[] = [
  ...
  { id: "organize", name: "Organize pages", description: "Reorder, duplicate, delete, and crop pages.", category: "organize", keywords: ["rearrange", "delete", "order"], icon: Grid2X2, accept: ".pdf,application/pdf", status: "planned", output: "PDF" },
